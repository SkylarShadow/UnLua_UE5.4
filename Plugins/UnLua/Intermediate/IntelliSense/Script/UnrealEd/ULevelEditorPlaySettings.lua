...
---@field private bOneHeadsetEachProcess boolean @When True each PIE process is launched with "-HMDSimulator" argument. The usefullness of this will vary by XR platform. The PIE instances may get special -HMDSimulator behavior from an XR plugin, they may successfully make connections to the HMD hardware, their attempt to connect to hardware may be rejected by the runtime.
