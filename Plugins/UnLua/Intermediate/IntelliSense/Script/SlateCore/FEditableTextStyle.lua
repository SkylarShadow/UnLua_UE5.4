...
---@field public BackgroundImageComposing FSlateBrush @Background image for the selected text
---@field public CaretImage FSlateBrush @Image brush used for the caret
