...
---@field public FontRasterizationMode EFontRasterizationMode @The preferred rasterization method for this font (enable / disable MSDF)
---@field public SdfSettings FFontSdfSettings @Settings for rendering this font using the sdf pipeline
