...
---@field private bIsInEditLevelInstance boolean @Whether this actor belongs to a level instance which is currently being edited.
---@field private bIsInEditLevelInstanceHierarchy boolean @Whether this actor belongs to a level instance in a level instance hierarchy currently being edited. Itself or its parent level instances.
---@field private bIsInLevelInstance boolean @Whether this actor belongs to a level instance
