...
---@field public MaxConvexCount integer @Maximum number of convex to generate per transform. Ignored if < 0.
...
---@field public bComputeNegativeSpacePerBone boolean @Whether to compute separate negative space for each bone. Otherwise, a single negative space will be computed once and re-used for all bones.
